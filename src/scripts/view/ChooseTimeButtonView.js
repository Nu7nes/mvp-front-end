export class ChooseTimeButtonView {
    constructor() {
        ...
        this.extraComponents = [
            document.querySelector("#cardVoluntary"),
    ...
    render() {
        ...
        setTimeout(() => {
            this.chooseTimeButton.style.display = "none";
        }, 100);

        setTimeout(() => {
            this.cardComponent.classList.add("changeWidth");
        }, 500);
        setTimeout(() => {
            this.formSchedule.classList.add("openTimesForm");
        }, 500);
    }
}
